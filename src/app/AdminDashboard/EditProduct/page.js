      ...
      <div className="bg-white rounded-[11px] p-3">
        ...
        >
          ...
          <div className="flex flex-col ">
            ...
            <label className="border  border-[var(--primary-border)] rounded-[11px] h-36 px-5 cursor-pointer flex flex-col items-center justify-center gap-2 bg-white hover:bg-gray-50 transition">
