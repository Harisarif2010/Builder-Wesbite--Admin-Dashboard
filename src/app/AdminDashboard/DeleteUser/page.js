        ...
        <div className="bg-white rounded-[22px] p-8">
          ...
          >
            ...
            <div className="flex  gap-x-3">
              ...
              <button
                className="bg-[#C82112] text-[white] text-lg  flex justify-center items-center  px-10 py-5   font-medium rounded-[22px] h-14"
                onClick={openModal}
              >
                Delete
              </button>
          ...
          <DeleteAccountModal isOpen={isOpen} onClose={closeModal} />
        </div>
      </div>
    </>
  );
